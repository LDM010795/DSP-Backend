...
from .serializers import DepartmentSerializer, PositionSerializer, EmployeeSerializer, AttendanceSerializer, ToolSerializer, EmployeeToolAccessSerializer
...
class EmployeeViewSet(viewsets.ModelViewSet):
    ...
    """
    queryset = Employee.objects.select_related('department', 'position').all().order_by('last_name', 'first_name')
