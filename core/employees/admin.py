...
class EmployeeAdmin(admin.ModelAdmin):
    list_display = ['full_name', 'department', 'position', 'max_working_hours', 'is_active']
    ...
    fieldsets = (
        ...
        ('Arbeitsplatz', {
            'fields': ('department', 'position', 'max_working_hours')
        }),
        ('Status', {
            'fields': ('is_active',)
        }),
...
class EmployeeToolAccessAdmin(admin.ModelAdmin):
    ...
    search_fields = ("employee__first_name", "employee__last_name", "employee__email", "tool__slug")
