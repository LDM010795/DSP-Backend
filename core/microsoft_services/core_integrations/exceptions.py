...
class ResourceNotFoundException(MicrosoftGraphException):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, status_code=404, error_code="ItemNotFound", details=details
        )
...
class BadRequestException(MicrosoftGraphException):
    ...
    def __init__(
        ...
        super().__init__(
            message=message, status_code=400, error_code="BadRequest", details=details
        )
...
def create_exception_from_response(
    status_code: int, message: str, error_code: Optional[str] = None, **kwargs
