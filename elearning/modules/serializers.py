...
class TaskSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ['id', 'chapter', 'title', 'description', 'difficulty', 'hint', 'order', 'completed', 'task_type', 'task_config']
...
class ChapterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Chapter
        fields = ['id', 'module', 'module_id', 'title', 'description', 'order', 'is_active', 'contents']
        extra_kwargs = {
            'module': {'read_only': True}
        }
