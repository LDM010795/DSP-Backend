    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            ...
            options={
                ...
                "verbose_name_plural": "User Task Progress Entries",
            },
        ),
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                help_text="Detailed description or text content",
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                default=0,
                help_text="Order of content within the module (0 = first)",
                verbose_name="Display Order",
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Optional additional title or subtitle",
                max_length=200,
                null=True,
                verbose_name="Supplementary Title",
            ),
        ),
        migrations.AlterField(
            model_name="content",
            name="title",
            field=models.CharField(
                help_text="Descriptive title for this content item",
                max_length=255,
        ...
        migrations.AlterField(
            ...
            name="title",
            field=models.CharField(
                help_text="The unique title of the learning module",
                max_length=200,
                unique=True,
        ...
        migrations.AlterField(
            ...
            name="module",
            field=models.ForeignKey(
                help_text="Module that user has been granted access to",
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            name="user",
            field=models.ForeignKey(
                help_text="User granted access to the module",
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            name="name",
            field=models.CharField(
                help_text="Unique name for this module category",
                max_length=100,
                unique=True,
        ...
        migrations.AlterField(
            ...
            name="content",
            field=models.ForeignKey(
                help_text="Content item this supplementary material belongs to",
                on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AlterField(
            ...
            name="label",
            field=models.CharField(
                help_text="Descriptive label for the supplementary link",
                max_length=200,
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                default=0,
                help_text="Order of supplementary links within content",
                verbose_name="Display Order",
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="description",
            field=models.TextField(
                help_text="Detailed instructions and requirements for the task",
        ...
        migrations.AlterField(
            ...
            name="difficulty",
            field=models.CharField(
                choices=[("Einfach", "Easy"), ("Mittel", "Medium"), ("Schwer", "Hard")],
                default="Mittel",
                help_text="Difficulty level for student guidance",
                max_length=10,
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                help_text="Optional hint to help students solve the task",
                null=True,
                verbose_name="Hint",
            ),
        ),
        migrations.AlterField(
            ...
            name="module",
            field=models.ForeignKey(
                help_text="Module this task belongs to",
                on_delete=django.db.models.deletion.CASCADE,
                related_name="tasks",
                to="elearning.module",
                verbose_name="Module",
        ...
        migrations.AlterField(
            ...
            field=models.PositiveIntegerField(
                default=0,
                help_text="Order of tasks within the module",
                verbose_name="Display Order",
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="title",
            field=models.CharField(
                help_text="Descriptive title for the programming task",
                max_length=255,
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Whether the user has completed this task",
        ...
        migrations.AddIndex(
            model_name="usertaskprogress",
            index=models.Index(
                fields=["user", "completed"], name="elearning_u_user_id_dee084_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="usertaskprogress",
            index=models.Index(
                fields=["task", "completed"], name="elearning_u_task_id_35ddf5_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="usertaskprogress",
            index=models.Index(
                fields=["completed_at"], name="elearning_u_complet_497fdc_idx"
            ),
        ),
