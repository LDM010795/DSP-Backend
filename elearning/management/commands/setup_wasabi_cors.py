...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if dry_run:
            self.stdout.write(self.style.WARNING("DRY RUN: CORS-Konfiguration wird nur simuliert"))
    ...
    def configure_cors(self, dry_run=False):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Fehler beim Initialisieren des S3 Clients: {e}"))
            return False
        ...
        try:
            ...
            self.stdout.write(self.style.SUCCESS(f"CORS-Konfiguration für Bucket '{bucket_name}' erfolgreich angewendet"))
    ...
    def verify_cors_configuration(self):
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"Keine CORS-Konfiguration gefunden: {e}"))
